...
const Dashboard = () => {
  ...
  const getDailyForecasts = () => {
    ...
    forecasts.forEach((forecast) => {
      const day = new Date(forecast.dt * 1000).toLocaleString("en-US", {
        weekday: "long",
      });
    ...
    datasets: [
      {
        ...
        data: [
          salesDataValues.totalSales,
          salesDataValues.productsForRent,
          salesDataValues.averageReviews,
        ],
        backgroundColor: [
          "rgba(255,99,132,0.6)",
          "rgba(54,162,235,0.6)",
    ...
    datasets: [
      {
        label: "Revenue",
        data: [
          { x: salesDataValues.totalSales, y: salesDataValues.averageReviews },
        ],
            ...
            <Row>
              <Col sm={3}>
                <Nav variant="pills" className="flex-column">
                  <Nav.Item>
                    <Nav.Link eventKey="currentWeather">
                      {t("dashboard.currentWeatherTab")}
                    </Nav.Link>
                  </Nav.Item>
                  <Nav.Item>
                    <Nav.Link eventKey="forecast">
                      {t("dashboard.forecastTab")}
                    </Nav.Link>
                  </Nav.Item>
                  <Nav.Item>
                    <Nav.Link eventKey="salesMetrics">
                      {t("dashboard.salesMetricsTab")}
                    </Nav.Link>
                  </Nav.Item>
                </Nav>
              </Col>
                      ...
                      <Card className="mb-4">
                        <Card.Body>
                          ...
                          <p className="text-muted">
                            {t("dashboard.temperatureForecastDescription")}
                          </p>
                        </Card.Body>
                      </Card>
                    )}
                      ...
                      <>
                        <Card className="mb-4">
                          <Card.Body>
                            ...
                            />
                            <p className="text-muted">
                              {t("dashboard.salesMetricsDescription")}
                            </p>
                          </Card.Body>
                        </Card>
                        ...
                        <Card className="mb-4">
                          <Card.Body>
                            ...
                            />
                            <p className="text-muted">
                              {t("dashboard.rentReviewsDescription")}
                            </p>
                          </Card.Body>
                        </Card>
                        ...
                        <Card className="mb-4">
                          <Card.Body>
                            ...
                            />
                            <p className="text-muted">
                              {t("dashboard.reviewsVsSalesDescription")}
                            </p>
                          </Card.Body>
                        </Card>
                        ...
                        <Card className="mb-4">
                          <Card.Body>
                            ...
                            />
                            <p className="text-muted">
                              {t("dashboard.totalSalesOverTimeDescription")}
                            </p>
                          </Card.Body>
                        </Card>
                      </>
